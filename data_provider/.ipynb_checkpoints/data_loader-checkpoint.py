...
class Dataset_ETT_hour(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='OT', scale=True, timeenc=0, freq='h', cycle=None, week_cycle=None):
    ...
    def __read_data__(self):
        ...
        self.week_cycle_index =  (np.arange(len(data)) % self.week_cycle)[border1:border2]
    def __getitem__(self, index):
        ...
        week_cycle_index = torch.tensor(self.week_cycle_index[s_end])

        return seq_x, seq_y, seq_x_mark, seq_y_mark, cycle_index,week_cycle_index
